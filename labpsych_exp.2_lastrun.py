...
expName = 'labpsych_exp.2'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/tanmayikalapatapu/Downloads/labpsych_exp.2_lastrun.py',
...
trials = data.TrialHandler(nReps=101.0, method='random', 
...
# completed 101.0 repeats of 'trials'
